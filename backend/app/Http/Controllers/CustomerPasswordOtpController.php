...
class CustomerPasswordOtpController extends Controller
{
    // STEP 1: SEND OTP
    public function sendOtp(Request $request)
    {
        ...
        // delete previous OTP
        CustomerPasswordOtp::where('email', $request->input('email'))->delete();

        CustomerPasswordOtp::create([
    ...
    public function verifyOtp(Request $request)
    {
        ...
        $record = CustomerPasswordOtp::where('email', $request->input('email'))->first();
